...
namespace DIO.Bank
{
    class Program
    {
        ...
        private static void Transferir()
        {
            ...
            int indiceContaOri = int.Parse(Console.ReadLine());

            Console.Write("Digite o número da conta de destino: ");
            int indiceContaDest = int.Parse(Console.ReadLine());

            Console.Write("Digite o valor a ser transferido: ");
            double valorTransferencia = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);

            listContas[indiceContaOri].Transferir(valorTransferencia, listContas[indiceContaDest]);
        }
